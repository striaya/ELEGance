          ...
          <table class="data-table">
            ...
            <tbody>
              <?php if (empty($recentProduk)): ?>
                <tr><td colspan="3" style="text-align:center;color:var(--text-light);padding:28px">Belum ada produk</td></tr>
              <?php else: ?>
          ...
          <table class="data-table">
            ...
            <tbody>
              <?php if (empty($recentUser)): ?>
                <tr><td colspan="3" style="text-align:center;color:var(--text-light);padding:28px">Belum ada pengguna</td></tr>
              <?php else: ?>
